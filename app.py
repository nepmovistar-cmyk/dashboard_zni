# Autor:  Natalia Piedrahita
import streamlit as st
import pandas as pd
import plotly.graph_objects as go
import plotly.express as px

ruta = 'https://github.com/nepmovistar-cmyk/My_Bootcamp/raw/refs/heads/main/estado_zni.csv'
df = pd.read_csv(ruta)
...
with st.sidebar.container():
    ...
    st.markdown('[Indicadores por Departamento](#tortas)')
